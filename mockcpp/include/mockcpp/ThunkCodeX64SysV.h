...
#define PUSH_RDI   0x40, 0x57,
#define PUSH_RSI   0x40, 0x56,
#define PUSH_RDX   0x40, 0x51, 
#define PUSH_RCX   0x40, 0x50, 
#define MOV_R9_R8  0x4d, 0x89, 0xc1,       
#define MOV_R8_RCX 0x49, 0x89, 0xc8,       
#define MOV_RCX_RDX  0x48, 0x89, 0xd1,       
#define MOV_RDX_RSI  0x48, 0x89, 0xF2, 
#define MOV_RSI_RDI  0x48, 0x89, 0xFE,
#define SUB_RSP(n) 0x48, 0x83, 0xec, (n+2)*0x08,
#define ADD_RSP(n) 0x48, 0x83, 0xc4, (n+2)*0x08,
#define MOV_RAX_NEW_ADDR 0x48, 0xB8, ZERO_ADDR,
#define MOV_RDI_OLD_ADDR 0x48, 0xBF, ZERO_ADDR,
...
#define MOCKCPP_THUNK_CODE_TEMPLATE(n) \
...
{ \
 ...
 \
    ...
    \
    size_t oldAddrOffset() const { return 39; } \
    size_t newAddrOffset() const { return 29; } \
}

MOCKCPP_THUNK_CODE_TEMPLATE(0);
MOCKCPP_THUNK_CODE_TEMPLATE(1);
MOCKCPP_THUNK_CODE_TEMPLATE(2);
MOCKCPP_THUNK_CODE_TEMPLATE(3);
MOCKCPP_THUNK_CODE_TEMPLATE(4);
MOCKCPP_THUNK_CODE_TEMPLATE(5);
